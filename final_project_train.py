...
if __name__ == "__main__":
    ...
    if not VIDEO :
        ...
        flat_spe = np.load("results/ice_specialist_cmaes/100/x_best.npy")  # shape: (n_weights,)
        ...
        ice_spe = np.load("results/ice_specialist_cmaes/100/x_best.npy")
        # Output layer is the last n_con2 = 8*16 = 128 weights
        n_input, n_hidden, n_output = 27, 16, 8
        n_con1 = n_input * n_hidden   # 432 - input layer weights, untouched
        n_con2 = n_hidden * n_output  # 128 - output layer weights, need reordering
    ...
    if VIDEO :
        ...
        """
        evaluate_checkpoint(
            checkpoint_dir="results/ice_specialist_cmaes/100",
            output_dir="/Users/edgarcolin/Documents/micro-515-EvoRob/micro-515-EvoRob/results/test",
