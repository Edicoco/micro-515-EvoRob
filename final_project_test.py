...
ROBOT_XML_PATH = "results/flat_specialist_cmaes/1000/Robot.xml"   # e.g. "/abs/path/to/Robot.xml"
GENOTYPE_PATH  = "results/flat_specialist_cmaes/1000/x_best.npy"   # e.g. "/abs/path/to/x_best.npy"
