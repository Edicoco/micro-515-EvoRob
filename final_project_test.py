...
ROBOT_XML_PATH = "results/final_project_cluster/270/Robot.xml"   # e.g. "/abs/path/to/Robot.xml"
GENOTYPE_PATH  = "results/final_project_cluster/270/x_best.npy"   # e.g. "/abs/path/to/x_best.npy"
